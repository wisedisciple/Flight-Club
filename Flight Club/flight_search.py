...
class FlightSearch:
    ...
    def __init__(self):
        ...
        self._api_secret = os.getenv("AMADEUS_API_SECERET")
        # This gets a new token every time the program runs
    ...
    def _get_new_token(self):
        ...
        token_response = requests.post(url=TOKEN_ENDPOINT, data=amadeus_params, headers=token_headers)
        access_token = token_response.json().get("access_token")
        # New token typically expires in 1799 seconds (30 min)
        return access_token
